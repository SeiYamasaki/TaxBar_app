        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('dashboard') }}"
                    class="flex items-center px-4 py-2 text-lg text-gray-700 {{ request()->routeIs('dashboard') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                ...
                <a href="{{ route('taxminivideos.manage') }}"
                    class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('taxminivideos.manage') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                    <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('comments.received') }}"
                    class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('comments.received') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                    <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- クライアント管理 -->
                <a href="#"
                    class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('clients') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                    <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('tax_advisor.profile.edit') }}"
                    class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('tax_advisor.profile.edit') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                    <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('pricing.index') }}"
                    class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('pricing.index') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                    <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="flex items-center px-4 py-2 text-lg text-gray-600 {{ request()->routeIs('logout') ? 'bg-gray-100' : '' }} hover:bg-gray-100 rounded-lg">
                        <svg class="w-10 h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
