...
<body class="bg-gray-100 font-sans">
    ...
    <main class="container mt-24 mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-10">マイコメント一覧</h1>

        <!-- フィルタリングオプション -->
        <div class="mb-8 bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('comments.my') }}" method="GET" class="flex flex-wrap gap-4 items-end">
        ...
        <div class="space-y-6">
            ...
            @else
                <div class="bg-white p-8 rounded-lg shadow-md text-center">
                    <p class="text-gray-500 text-lg">投稿したコメントはありません</p>
                </div>
            @endif
        </div>
